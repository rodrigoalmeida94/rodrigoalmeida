...
\begin{center}
    ...
    \href{https://rodrigoalmeida.pt}{\faGlobe} \quad | \quad
    \href{https://github.com/rodrigoalmeida94}{\faGithub} \quad | \quad
    \href{https://www.linkedin.com/in/rodrigomalmeida/}{\faLinkedin}
\end{center}
...
\begin{minipage}[t]{0.48\textwidth}
    ...
    \begin{itemize}[leftmargin=*, noitemsep, topsep=0pt]
        \item \href{https://doi.org/10.48550/arXiv.2608.30795}{Uncertainty-Aware End-to-End AI Weather Forecasting: Disentangling Observation and Model Contributions} \textsl{(Pre-print)}
        \item \href{https://doi.org/10.1175/AIES-D-25-0113.1}{On the Predictive Skill of AI-Based Weather Models for Extreme Events Using Uncertainty Quantification} \textsl{(Journal)}
...
\entry{Fraunhofer HHI}{Berlin}{ML Researcher \& PhD Candidate, Applied AI}{Feb 2025 -- Present}
\begin{itemize}[leftmargin=15pt, nosep]
    \item Quantifying uncertainty in global AI weather models, evaluating on extreme events (published in AMS AIES).
    \item Probabilistic end-to-end AI weather forecasting, disentangling observation and model uncertainty.
    \item Robotics and AI.
\end{itemize}
\vspace{2pt}
