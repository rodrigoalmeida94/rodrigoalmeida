...
\begin{itemize}[leftmargin=15pt, nosep]
    \item Uncertainty quantification of global AI weather models, evaluating on extreme events.
    \item Climate and Weather AI applications.
\end{itemize}
\vspace{2pt}
...
\begin{itemize}[leftmargin=15pt, nosep]
    \item Used FastAPI to develop asynchronous micro services to estimate resource consumption of geospatial workflows.
...
\entry{Agroop}{Lisbon}{Account Manager and Agronomist}{Oct 2015 -- Aug 2016}
\begin{itemize}[leftmargin=15pt, nosep]
    \item Agronomic technical assistance to customers.
    \item Supported the development team with user requirement reports.
\end{itemize}
